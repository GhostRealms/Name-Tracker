...
import mojang.api.http.BasicHttpClient;
import mojang.api.http.HttpBody;
import mojang.api.http.HttpClient;
import mojang.api.http.HttpHeader;
import mojang.api.profiles.Profile;
import mojang.api.profiles.ProfileCriteria;
import mojang.api.profiles.ProfileRepository;
import mojang.api.profiles.ProfileSearchResult;
